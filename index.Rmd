...
### `r shiny::icon("exclamation-triangle")` ***NEW!***<br>11. Most prevalent beats:<br>Tempi around *100 BPM* and *120BPM* most common in corpus.
...
### `r shiny::icon("exclamation-triangle")` ***NEW!***<br>10. Most prevalent beats:<br>Tempi around *100 BPM* and *120BPM* most common in corpus.
...
mc <- mood %>% 
  ...
  scale_fill_viridis_c() +
  theme_minimal() +
  labs(x = "Time (s)", y = "", fill = "Magnitude", title = " ", subtitle = "Chordogram")
...
The [Chordify algorithm](https://chordify.net/chords/24kgoldn-mood-official-video-ft-iann-dior-24kgoldnvevo){target="_blank"} identified the chords the following (4/4) loop:
...
tabBox(width=NULL,
       height = 1000,
       title = tagList(shiny::icon("music"),"Key freqencies"),
       id = "tabset2",
...
The histogram does not show a clear preference of keys, although C♯, F♯, G♯ consistently have a relative high count