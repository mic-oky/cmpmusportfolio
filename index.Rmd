...
### `r shiny::icon("exclamation-triangle")` ***NEW!***<br>12.1 Is it **impossible to predict** whether a track was in the charts **before or during the pandemic**.
...
### `r shiny::icon("exclamation-triangle")` ***NEW!***<br>12.2 Is it **impossible to predict** whether a track was in the charts **before or during the pandemic**.
...
### `r shiny::icon("exclamation-triangle")` ***NEW!***<br>12.3 Is it **impossible to predict** whether a track was in the charts **before or during the pandemic**.
...
p10_1 <- pc %>%  
#ggplot(aes(x = key_key, fill = as.factor(mode))) +
ggplot(aes(x = tempo, fill = year...32)) +
  #facet_wrap(~ year...31) +
  scale_fill_viridis_d(
    alpha = 0.7,
    begin = 0.2,
