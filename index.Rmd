...
p1 <- ggplot(sd_19, aes(x = valence, y = energy, colour = week...14, label = `Track Name`, label2 = Artist)) + geom_point(aes(size = danceability, alpha = 0.4, fill = week...14, color = Position)) + theme_light() 
