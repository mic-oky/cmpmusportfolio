...
p <- ggplot(z, aes(mean_valence, mean_energy, size = mean_dance, color = mean_tempo, label = week_year, label2 = top_track)) +
  geom_point() +
  facet_grid(. ~ year...26)
...
Christmas songs started to dominate the charts in 2020 around week 49 until week 53, whereas in 2019 Christmas this phenomenon occurred much later. In 2020 it is noticable that the bottom corner with tracks with relatively high BPM, high valence, and low energy are from the weeks when Christmas tracks dominated the charts. In 2019 this phenomenon is very noticeable in week 52, but shows that Christmas started in week 50. Also in 2020, the charts kept their similarity during the holiday period, whereas in 2019, it suddenly shot up (or downwards in the plot) in week 52.
